...
const {observable, subscribe, unsubscribe, notify, update} = require('iobserver');
...
describe('iobserver', () => {
    it('subscribe/unsubscribe/notify', () => {
        ...
        let onNotify = (value) => user.counter++; // this is just for example, but will be called on notify
        subscribe(user, onNotify);
